			...
			<div class="row header-header">
							...
							<li class="user-login"><a href="#"> <i
								...
								<div class="sub-user">
									...
									<c:if test="${sessionScope.email ==null}">
										<div class="user-item">
											<div class="sign-in">
												<i class="fas fa-user-plus"></i> <a href="signup">Đăng
													kí</a>
											</div>
										</div>
										<div class="user-item">
									...
									<c:if test="${sessionScope.email !=null}">
										<p style="color: red; padding-left: 15px">${sessionScope.email }</p>
										<div class="user-item">
											<div class="sign-in">
												<i class="fas fa-user-plus"></i> <a
													href="my_account?email=${sessionScope.email }">Thông
													tin tài khoản</a>
											</div>
										</div>
										<div class="user-item">
				...
				<div class="col-md-9 col-sm-12 hidden-xs">
					<div class="mainmenu text-center">
						<nav>
							<ul id="nav">
								<li><a href="<%=request.getContextPath()%>/shop">Sách</a></li>
								<li><a href="<%=request.getContextPath()%>/sale">Khuyến
										mãi</a></li>
								<li><a href="<%=request.getContextPath()%>/admin">Liên
										Hệ</a></li>
							</ul>
						</nav>
					</div>
					...
					<div class="header-right">
						<ul>
								...
								<div class="sub-user">
									<c:if test="${sessionScope.email ==null}">
										<div class="user-item">
											<div class="sign-in">
												<i class="fas fa-user-plus"></i> <a
													href="<%=request.getContextPath()%>/signup">Đăng kí</a>
											</div>
										</div>
										<div class="user-item">
											<div class="sign-in">
									...
									<c:if test="${sessionScope.email !=null}">
										<p style="color: red">${sessionScope.email }</p>
										<div class="user-item">
											<div class="sign-in">
												<i class="fas fa-user-plus"></i> <a
													href="<%=request.getContextPath()%>/my_account?email=${sessionScope.email }">Thông
													tin tài khoản</a>
											</div>
										</div>
										<div class="user-item">
							...
							<li class="shoping-cart"><a
								href="<%=request.getContextPath()%>/shopping_cart"> <i
									class="flaticon-shop"><span style="color: white-space:;">
				...
				<div class="col-lg-12 col-md-12 col-sm-12">
					<div class="mobile-menu">
						<nav id="dropdown">
							<ul>
								<li><a href="<%=request.getContextPath()%>/shop">Sách</a></li>
								<li><a href="<%=request.getContextPath()%>/shop">Khuyến
										mãi</a></li>
								<li><a href="<%=request.getContextPath()%>/admin">Liên
										Hệ</a></li>
							</ul>
