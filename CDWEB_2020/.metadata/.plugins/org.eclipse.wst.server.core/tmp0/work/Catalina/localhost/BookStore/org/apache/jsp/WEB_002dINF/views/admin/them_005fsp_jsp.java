 ...
 * Generated at: 2021-01-17 09:46:12 UTC
...
public final class them_005fsp_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/WEB-INF/views/admin/header.jsp", Long.valueOf(1610719668011L));
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t\t<a href=\"admin\"> <img class=\"main-logo\" style=\"width: 200px\"\r\n");
      out.write("\t\t\t\t\tsrc=\"\" alt=\"\" />\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\thref=\"");
      out.print(request.getContextPath());
      out.write("/admin/listProductType\"><span class=\"mini-sub-pro\">Quản\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tlý loại sản phẩm</span></a></li>\r\n");
      out.write("\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<li><a title=\"Đăng nhập\" href=\"\"><span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\tclass=\"mini-sub-pro\">Đăng nhập</span></a></li>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tChào mừng Pate-ER <span class=\"bread-ntd\">Admin</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</p>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t<!-- @section jsFooter\n");
      out.write("{\n");
      out.write("  <script>\n");
      out.write("    $('#chonanh').on('click',function(e) {\n");
      out.write("        e.preventDefault();\n");
      out.write("      var finder = new CKFinder();\n");
      out.write("          finder.selectActionFunction = function(url) {\n");
      out.write("            $('#image').val(url);\n");
      out.write("          };\n");
      out.write("              finder.popup();\n");
      out.write("    })\n");
      out.write("    \n");
      out.write("    var editor = CKEDITOR.replace('content',{\n");
      out.write("        customConfig: '/plugins/ckeditor/config.js',\n");
      out.write("    })\n");
      out.write("  </script>\n");
      out.write("\n");
      out.write("} -->\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\tclass=\"icon nalika-edit\" aria-hidden=\"true\"></i> Thêm sản\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\tphẩm</a></li>\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\n");
      ...
      try {
        ...
        // /WEB-INF/views/admin/them_sp.jsp(64,12) name = action type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_form_005fform_005f0.setAction("addProduct");
        // /WEB-INF/views/admin/them_sp.jsp(64,12) name = method type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_form_005fform_005f0.setMethod("POST");
        // /WEB-INF/views/admin/them_sp.jsp(64,12) name = modelAttribute type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
        _jspx_th_form_005fform_005f0.setModelAttribute("books");
        // /WEB-INF/views/admin/them_sp.jsp(64,12) name = enctype type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
          ...
          if (_jspx_eval_form_005fform_005f0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
            do {
              ...
              try {
                ...
                // /WEB-INF/views/admin/them_sp.jsp(69,13) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_form_005ferrors_005f0.setPath("hinhAnh");
                // /WEB-INF/views/admin/them_sp.jsp(69,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              try {
                ...
                // /WEB-INF/views/admin/them_sp.jsp(73,13) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_form_005ferrors_005f1.setPath("tenSach");
                // /WEB-INF/views/admin/them_sp.jsp(73,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              try {
                ...
                // /WEB-INF/views/admin/them_sp.jsp(76,13) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_form_005ferrors_005f2.setPath("theloaisach");
                // /WEB-INF/views/admin/them_sp.jsp(76,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              out.write("\n");
              out.write("\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<br /> Giá: <input name=\"gia\" type=\"datetime\"\n");
              ...
              try {
                ...
                // /WEB-INF/views/admin/them_sp.jsp(80,13) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_form_005ferrors_005f3.setPath("gia");
                // /WEB-INF/views/admin/them_sp.jsp(80,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              try {
                ...
                // /WEB-INF/views/admin/them_sp.jsp(83,13) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_form_005ferrors_005f4.setPath("tenTacGia");
                // /WEB-INF/views/admin/them_sp.jsp(83,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              try {
                ...
                // /WEB-INF/views/admin/them_sp.jsp(86,13) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_form_005ferrors_005f5.setPath("moTa");
                // /WEB-INF/views/admin/them_sp.jsp(86,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              out.write("\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<br />\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tKhuyến mãi: <input name=\"khuyenMai\" type=\"datetime\"\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" />\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t");
              //  form:errors
              ...
              try {
                ...
                // /WEB-INF/views/admin/them_sp.jsp(90,13) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_form_005ferrors_005f6.setPath("khuyenMai");
                // /WEB-INF/views/admin/them_sp.jsp(90,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              try {
                ...
                // /WEB-INF/views/admin/them_sp.jsp(93,13) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_form_005ferrors_005f7.setPath("ngayXuatBan");
                // /WEB-INF/views/admin/them_sp.jsp(93,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              try {
                ...
                // /WEB-INF/views/admin/them_sp.jsp(96,13) name = path type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
                _jspx_th_form_005ferrors_005f8.setPath("soLuong");
                // /WEB-INF/views/admin/them_sp.jsp(96,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
              ...
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a id=\"chonanh\" href=\"#\">Chọn ảnh</a> <input\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"ckeditor form-control\" name=\"hinhAnh\" id=\"image\"\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\trows=\"3\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-group mg-b-pro-edt\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon\"> <i\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"icon nalika-edit\" aria-hidden=\"true\"></i></span> <input\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"text\" name=\"tenSach\" class=\"form-control\"\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Tên\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-group mg-b-pro-edt\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon\"> <i\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-usd\" aria-hidden=\"true\"></i></span> <input\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"text\" class=\"form-control\" name=\"gia\"\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Giá\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
              out.write("\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-group mg-b-pro-edt\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon\"> <i\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"icon nalika-favorites\" aria-hidden=\"true\"></i></span> <input\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"text\" class=\"form-control\" name=\"loaiSach\"\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Loại\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-group mg-b-pro-edt\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon\"> <i\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-usd\" aria-hidden=\"true\"></i></span> <input\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"text\" class=\"form-control\" name=\"soLuong\"\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Số lượng\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"moTa\">Mô tả</label>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea class=\"ckeditor\" runat=\"server\" name=\"moTa\"\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\trows=\"3\" id=\"content\"></textarea>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"input-group mg-b-pro-edt\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<span class=\"input-group-addon\"> <i\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"fa fa-usd\" aria-hidden=\"true\"></i></span> <input\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\ttype=\"text\" class=\"form-control\" name=\"tenTacGia\"\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tplaceholder=\"Số lượng\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<label for=\"moTa\">Mô tả</label>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<textarea class=\"ckeditor\" runat=\"server\"\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tname=\"ngayXuatBan\" rows=\"3\" id=\"content\"></textarea>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"col-lg-12 col-md-12 col-sm-12 col-xs-12\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"text-center custom-pro-edt-ds\">\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button type=\"submit\"\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"btn btn-ctl-bt waves-effect waves-light\">LƯU\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t</button>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div> -->\n");
              out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
  ...
  private boolean _jspx_meth_form_005finput_005f0(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/admin/them_sp.jsp(68,13) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005finput_005f0.setPath("hinhAnh");
      // /WEB-INF/views/admin/them_sp.jsp(68,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005finput_005f1(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/admin/them_sp.jsp(72,13) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005finput_005f1.setPath("tenSach");
      // /WEB-INF/views/admin/them_sp.jsp(72,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005finput_005f2(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/admin/them_sp.jsp(75,13) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005finput_005f2.setPath("theloaisach");
      // /WEB-INF/views/admin/them_sp.jsp(75,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005finput_005f3(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/admin/them_sp.jsp(82,13) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005finput_005f3.setPath("tenTacGia");
      // /WEB-INF/views/admin/them_sp.jsp(82,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005finput_005f4(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/admin/them_sp.jsp(85,13) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005finput_005f4.setPath("moTa");
      // /WEB-INF/views/admin/them_sp.jsp(85,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005finput_005f5(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/admin/them_sp.jsp(92,13) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005finput_005f5.setPath("ngayXuatBan");
      // /WEB-INF/views/admin/them_sp.jsp(92,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
  ...
  private boolean _jspx_meth_form_005finput_005f6(javax.servlet.jsp.tagext.JspTag _jspx_th_form_005fform_005f0, javax.servlet.jsp.PageContext _jspx_page_context, int[] _jspx_push_body_count_form_005fform_005f0)
    ...
    try {
      ...
      // /WEB-INF/views/admin/them_sp.jsp(95,13) name = path type = null reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_form_005finput_005f6.setPath("soLuong");
      // /WEB-INF/views/admin/them_sp.jsp(95,13) name = cssClass type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
